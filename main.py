...
def word_count_reduce(group):
  """
    ...
    """
  ###TODO
  return (group[0], reduce(lambda x, y: x + y, group[0], group[1]))  #done jaimie
...
print(run_map_reduce(word_count_map, word_count_reduce, ['i am sam i am', 'sam is ham'])) # correct
